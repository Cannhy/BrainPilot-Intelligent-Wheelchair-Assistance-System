 ...
 * 
 */
package com.example.controller.ros;

import com.example.controller.ros.message.Clock;
import com.example.controller.ros.message.Remote;
import com.example.controller.ros.rosapi.message.Empty;
import com.example.controller.ros.rosapi.message.Topics;
import com.example.controller.ros.rosapi.message.Type;
import com.example.controller.ros.rosapi.message.MessageDetails;
import com.example.controller.ros.rosapi.message.TypeDef;
import com.example.controller.ros.rosapi.message.GetTime;
import com.example.controller.ros.rosbridge.ROSBridgeClient;
import com.example.controller.ros.message.Log;
...
public class Example {
    ...
    public static void main(String[] args) {        
        ROSBridgeClient client = new ROSBridgeClient("ws://172.20.10.8:9090");
        client.connect();
        testTopic(client);
//        try {
//        testService(client);
...
//        }
        ...
        try {
            ...
            Service<com.example.controller.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<com.example.controller.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.example.controller.ros.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new com.example.controller.ros.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            com.example.controller.ros.Topic<Log> logTopic = 
                    new com.example.controller.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        Topic<Remote> remoteTopic = new Topic<Remote>("/remote", Remote.class, client);
        remoteTopic.advertise();
        remoteTopic.publish(new Remote("11"));
    }
}
